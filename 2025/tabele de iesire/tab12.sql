...
(
 ...
 CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('810') AND D.CAPITOL IN (1204) AND CIS2.NVAL(D.COL1)=1 AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.CUIIO END))) AS COL1, 
 CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('821','822','823','824','825','826','827','828') AND D.CAPITOL IN (1204) AND CIS2.NVAL(D.COL1)=1 AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.CUIIO END))) AS COL2, 
 CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('821') AND D.CAPITOL IN (1204) AND CIS2.NVAL(D.COL1)=1 AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.CUIIO END))) AS COL3,
 CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('822') AND D.CAPITOL IN (1204) AND CIS2.NVAL(D.COL1)=1 AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.CUIIO END))) AS COL4,
 CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('823') AND D.CAPITOL IN (1204) AND CIS2.NVAL(D.COL1)=1 AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.CUIIO END))) AS COL5,
 CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('824') AND D.CAPITOL IN (1204) AND CIS2.NVAL(D.COL1)=1 AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.CUIIO END))) AS COL6,
 CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('825') AND D.CAPITOL IN (1204) AND CIS2.NVAL(D.COL1)=1 AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.CUIIO END))) AS COL7,
 CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('826') AND D.CAPITOL IN (1204) AND CIS2.NVAL(D.COL1)=1 AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.CUIIO END))) AS COL8,
 CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('827') AND D.CAPITOL IN (1204) AND CIS2.NVAL(D.COL1)=1 AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.CUIIO END))) AS COL9,
 CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('828') AND D.CAPITOL IN (1204) AND CIS2.NVAL(D.COL1)=1 AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.CUIIO END))) AS COL10
