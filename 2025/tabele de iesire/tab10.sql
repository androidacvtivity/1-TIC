...
(
 ...
 CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('650') AND D.CAPITOL IN (1186) AND CIS2.NVAL(D.COL1)=1 AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.CUIIO END))) AS COL1, 
 CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('661','662','663','664','665','666','667','668') AND D.CAPITOL IN (1186) AND CIS2.NVAL(D.COL1)=1 AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.CUIIO END))) AS COL2, 
 CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('661') AND D.CAPITOL IN (1186) AND CIS2.NVAL(D.COL1)=1 AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.CUIIO END))) AS COL3,
 CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('662') AND D.CAPITOL IN (1186) AND CIS2.NVAL(D.COL1)=1 AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.CUIIO END))) AS COL4,
 CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('663') AND D.CAPITOL IN (1186) AND CIS2.NVAL(D.COL1)=1 AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.CUIIO END))) AS COL5,
 CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('664') AND D.CAPITOL IN (1186) AND CIS2.NVAL(D.COL1)=1 AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.CUIIO END))) AS COL6,
 CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('665') AND D.CAPITOL IN (1186) AND CIS2.NVAL(D.COL1)=1 AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.CUIIO END))) AS COL7,
 CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('666') AND D.CAPITOL IN (1186) AND CIS2.NVAL(D.COL1)=1 AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.CUIIO END))) AS COL8,
 CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('667') AND D.CAPITOL IN (1186) AND CIS2.NVAL(D.COL1)=1 AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.CUIIO END))) AS COL9,
 CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('668') AND D.CAPITOL IN (1186) AND CIS2.NVAL(D.COL1)=1 AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.CUIIO END))) AS COL10,
 CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('670') AND D.CAPITOL IN (1186) AND CIS2.NVAL(D.COL1)=1 AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.CUIIO END))) AS COL11
