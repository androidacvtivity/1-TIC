...
(
 ...
 CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('831','832','833','834','835','836','837') AND D.CAPITOL IN (1204) AND CIS2.NVAL(D.COL1)=1 AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.CUIIO END))) AS COL1, 
 CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('831') AND D.CAPITOL IN (1204) AND CIS2.NVAL(D.COL1)=1 AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.CUIIO END))) AS COL2, 
 CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('832') AND D.CAPITOL IN (1204) AND CIS2.NVAL(D.COL1)=1 AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.CUIIO END))) AS COL3,
 CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('833') AND D.CAPITOL IN (1204) AND CIS2.NVAL(D.COL1)=1 AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.CUIIO END))) AS COL4,
 CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('834') AND D.CAPITOL IN (1204) AND CIS2.NVAL(D.COL1)=1 AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.CUIIO END))) AS COL5,
 CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('835') AND D.CAPITOL IN (1204) AND CIS2.NVAL(D.COL1)=1 AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.CUIIO END))) AS COL6,
 CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('836') AND D.CAPITOL IN (1204) AND CIS2.NVAL(D.COL1)=1 AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.CUIIO END))) AS COL7,
 CIS2.NVAL(COUNT(DISTINCT (CASE WHEN D.RIND  IN ('837') AND D.CAPITOL IN (1204) AND CIS2.NVAL(D.COL1)=1 AND C.FULL_CODE LIKE '%'||CD.CUATM||';%' THEN D.CUIIO END))) AS COL8
