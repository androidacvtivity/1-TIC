        ...
        attach: function (context, settings) {
            ...
            jQuery('input[type=checkbox]').change(function () {
             ...
             //START CAPITOL 5
                    ...
                    jQuery('#CAPITOL5_R511').attr("checked", false); jQuery('#CAPITOL5_R512').attr("checked", false);
                    jQuery('#CAPITOL5_R513').attr("checked", false); jQuery('#CAPITOL5_R514').attr("checked", false);
                    jQuery('#CAPITOL5_R515').attr("checked", false); 
                    jQuery('#CAPITOL5_R520').attr("checked", false);
