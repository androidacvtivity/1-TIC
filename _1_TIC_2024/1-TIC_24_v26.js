        ...
        attach: function (context, settings) {
            ...
            jQuery('input[type=checkbox]').change(function () {
                ...
                if (group == "CAPITOL1_R161_C1") {
                    ...
                    jQuery('#CAPITOL9_R910_C1').attr("checked", false); jQuery('#CAPITOL8_R910_C2').attr("checked", false);
                    jQuery('#CAPITOL9_R921_C1').attr("checked", false); jQuery('#CAPITOL8_R921_C2').attr("checked", false);
                    jQuery('#CAPITOL9_R922_C1').attr("checked", false); jQuery('#CAPITOL8_R922_C2').attr("checked", false);
                    jQuery('#CAPITOL9_R923_C1').attr("checked", false); jQuery('#CAPITOL8_R923_C2').attr("checked", false);
                    jQuery('#CAPITOL9_R924_C1').attr("checked", false); jQuery('#CAPITOL8_R924_C2').attr("checked", false);
                    jQuery('#CAPITOL9_R925_C1').attr("checked", false); jQuery('#CAPITOL8_R925_C2').attr("checked", false);
                    jQuery('#CAPITOL9_R926_C1').attr("checked", false); jQuery('#CAPITOL8_R926_C2').attr("checked", false);
                    jQuery('#CAPITOL9_R927_C1').attr("checked", false); jQuery('#CAPITOL8_R927_C2').attr("checked", false);
                    jQuery('#CAPITOL9_R931_C1').attr("checked", false); jQuery('#CAPITOL8_R931_C2').attr("checked", false);
                    jQuery('#CAPITOL9_R932_C1').attr("checked", false); jQuery('#CAPITOL8_R932_C2').attr("checked", false);
                    jQuery('#CAPITOL9_R933_C1').attr("checked", false); jQuery('#CAPITOL8_R933_C2').attr("checked", false);
                    jQuery('#CAPITOL9_R941_C1').attr("checked", false); jQuery('#CAPITOL8_R941_C2').attr("checked", false);
                    jQuery('#CAPITOL9_R951_C1').attr("checked", false); jQuery('#CAPITOL8_R951_C2').attr("checked", false);
                    jQuery('#CAPITOL9_R961_C1').attr("checked", false); jQuery('#CAPITOL8_R961_C2').attr("checked", false);
                    jQuery('#CAPITOL9_R971_C1').attr("checked", false); jQuery('#CAPITOL8_R971_C2').attr("checked", false);
