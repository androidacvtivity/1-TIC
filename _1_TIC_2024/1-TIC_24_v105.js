(function ($) {
        ...
        attach: function (context, settings) {
            ...
            jQuery('input[type=checkbox]').change(function () {
             ...
             //START CAPITOL 5
                    ...
                    group == "CAPITOL5_R510_C2"
                    // jQuery('#CAPITOL6_R660_C2').is(':checked')
                ) {
                    jQuery('#CAPITOL5_R510_before').hide();
                    jQuery('#CAPITOL5_R511').hide();
                    jQuery('#CAPITOL5_R512').hide();
                    jQuery('#CAPITOL5_R513').hide();
                    jQuery('#CAPITOL5_R514').hide();
                    jQuery('#CAPITOL5_R515').hide();
                ...
                else if (group == "CAPITOL5_R510_C1") {
                    jQuery('#CAPITOL5_R510_before').show(); jQuery('#CAPITOL5_R511').show(); jQuery('#CAPITOL5_R512').show(); jQuery('#CAPITOL5_R513').show();
                    jQuery('#CAPITOL5_R514').show(); jQuery('#CAPITOL5_R515').show(); jQuery('#CAPITOL5_R520').show();
                }
    ...
    webform.validators.inf1 = function (v, allowOverpass) {
        ...
        if ((values.CAPITOL5_R510_C1 == true && values.CAPITOL1_R130_C1 == true) && !(values.CAPITOL5_R511_C1 == true || values.CAPITOL5_R511_C2 == true) && (caemFill.indexOf(values.CAEM.substr(0, 1)) !== -1 && !(values.CAEM.substr(0, 4) == 'S951'))) {

            var caem = values.CAEM.substr(0, 1);
            webform.errors.push({
                'fieldName': 'CAPITOL5_R511_C1',
                'index': 0,
                'msg': Drupal.t('Cod eroare: 71-001.390. Rind.130 este Da atunci Rind.511 trebuie sa fie selectat DA sau NU')
            });
        }

        if ((values.CAPITOL5_R510_C1 == true && values.CAPITOL1_R130_C1 == true) && !(values.CAPITOL5_R512_C1 == true || values.CAPITOL5_R512_C2 == true) && (caemFill.indexOf(values.CAEM.substr(0, 1)) !== -1 && !(values.CAEM.substr(0, 4) == 'S951'))) {
            webform.errors.push({
        ...
        if ((values.CAPITOL5_R510_C1 == true && values.CAPITOL1_R130_C1 == true) && !(values.CAPITOL5_R513_C1 == true || values.CAPITOL5_R513_C2 == true) && (caemFill.indexOf(values.CAEM.substr(0, 1)) !== -1 && !(values.CAEM.substr(0, 4) == 'S951'))) {
            webform.errors.push({
        ...
        if ((values.CAPITOL5_R510_C1 == true && values.CAPITOL1_R130_C1 == true) && !(values.CAPITOL5_R514_C1 == true || values.CAPITOL5_R514_C2 == true) && (caemFill.indexOf(values.CAEM.substr(0, 1)) !== -1 && !(values.CAEM.substr(0, 4) == 'S951'))) {
            webform.errors.push({
                'fieldName': 'CAPITOL5_R514_C1',
                'index': 0,
                'msg': Drupal.t('Cod eroare: 71-001.43. Rind.130 este Da atunci Rind.514 trebuie sa fie selectat DA sau NU')
            });
        }


        if ((values.CAPITOL5_R510_C1 == true && values.CAPITOL1_R130_C1 == true) && !(values.CAPITOL5_R515_C1 == true || values.CAPITOL5_R515_C2 == true) && (caemFill.indexOf(values.CAEM.substr(0, 1)) !== -1 && !(values.CAEM.substr(0, 4) == 'S951'))) {
            webform.errors.push({
        ...
        */
        ...
        if ((values.CAPITOL1_R510_C1 == true && values.CAPITOL1_R130_C1 == true) && !(values.CAPITOL5_R520_C1 == true || values.CAPITOL5_R520_C2 == true) && (caemFill.indexOf(values.CAEM.substr(0, 1)) !== -1 && !(values.CAEM.substr(0, 4) == 'S951'))) {
            webform.errors.push({
